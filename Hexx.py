...
def logo():
 ...
 \x1b[1;37m•••••••••••••••••••••••••••••••••••••••
 [•] \033[1;37m𝗢𝘄𝗻𝗲𝗿      : YOUSSEF_SA
 [•] \033[1;37m𝗚𝗶𝘁𝗛𝘂𝗯     : YOUSSEF_577
 [•] \033[1;37m𝗦𝘁𝗮𝘁𝘂𝘀     : FREE
 [•] \033[1;37m𝗕𝗥𝗢𝗧𝗛𝗘𝗥    : SA. YOUSSEF DR_577
 [•] \033[1;37m𝗩𝗲𝗿𝘀𝗶𝗼𝗻    : {B}0.1
\x1b[1;37m•••••••••••••••••••••••••••••••••••••••••••''')
    p(logo)
def clear():
    print('\033[1;32m----------------------------------------------')
...
class iAmMain:
    ...
    def iAmMenu(self):
        #heck_again()
        logo()
        p(" [𝟭] \033[1;37mFile Cloning ")
        p(" [𝟮] \033[1;37mCreate File ")
        #p(" [𝟯] \033[2;34m] Cut Used Files Lines ")
...
########___________________FILE_Menu________############
    def file_menu(self):
        #check_again()
        logo()
        p(" [•] \033[2;31m𝗘𝘅𝗮𝗺𝗽𝗹𝗲 \033[92;1m/sdcard/filename.txt\033[1;37m")
        file = input(" [•] \x1b[1;37mPut File Path : ")
        try:
            id = open(file,"r").read().splitlines()
            self.method_select(id)
        except FileNotFoundError:
            p(" [•] \033[2;31mFile Path Incorrect ")
            sp(2);self.file_menu()
    ...
    def password_menu(self,id):
        ...
        logo()
        max = 20
        p(" [•] \033[1;37m𝗘𝘅𝗮𝗺𝗽𝗹𝗲 \033[1;32m1 , 2 , 3  to 15 Max ")
        try:
            plimit = int(input(" \033[1;37m[•] \x1b[1;37mPut limit : "))
            if plimit =="":
                plimit = 4
            elif plimit > max:
        ...
        p(" \033[97;1m[•] \033[1;37m[\033[1;92mON\033[1;97m/\033[1;91mOFF\033[1;97m] Airplane mode after 5 minutes \033[97;1m") 
        line()
    ...
    def saved_results(self,ok,cp):
        ...
        p(" [•] \033[2;32mTotal Ok Accounts : %s "%(len(ok)))
        p(" [•] \033[2;31mTotal Cp Accounts : %s "%(len(cp)))
        line()
